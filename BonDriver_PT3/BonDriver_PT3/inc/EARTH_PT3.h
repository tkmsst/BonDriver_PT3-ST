...
namespace PT {
	...
	public:
		// [機能] Bus インスタンスを生成
		// [説明] ドライバ名は "windrvr6_EARTHSOFT_PT3", "windrvr6" の順に試行します。
	...
	public:
		...
		virtual status LockBuffer  (void *ptr, uint32 size, void **handle) = 0;
		...
		virtual status SetTransferTestMode(ISDB isdb, uint32 tunerIndex, bool testMode = false, uint16 initial = 0, bool not = false) = 0;
