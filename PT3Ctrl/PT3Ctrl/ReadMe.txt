========================================================================
    Win32 アプリケーション: PT3Ctrl プロジェクトの概要
========================================================================

この PT3Ctrl アプリケーションは、AppWizard により作成されました。
...
PT3Ctrl.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル PT3Ctrl.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル PT3Ctrl.rc 
    にインクルードされます。
